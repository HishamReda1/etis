...
export default function PortfolioGrid({ theme }: { theme: "light" | "dark" }) {
  ...
  return (
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl font-bold text-foreground sm:text-4xl text-gray-800 dark:text-gray-100">
