...
import { InfiniteMovingLogos } from "../ui/Infinitelogos";
...
export default function ClientsPage({ theme }: { theme: "light" | "dark" }) {
  ...
  return (
    <div className="clientSection overflow-hidden w-full h-full">
      <h1 className={cn("text-3xl font-bold", theme === "light" ? "text-gray-800" : "text-white")}>Our  <span className="text-[#8DC63F] dark:text-[#00AEEF]"> Clients</span></h1>
