...
const FactoryCanvas = dynamic(() => import("./FactoryCanvas"), { ssr: false });

export default function AboutPage({ theme }: { theme: "light" | "dark" }) {
  return (
    <div className="space-y-16 px-4 md:px-10 py-10">
      {/* Title: Our Company */}
      <h1 className={cn("text-3xl font-bold", "text-gray-800 dark:text-white")}>
      ...
      {/* Title: Our Gallery */}
      <h1 className={cn("text-3xl font-bold", "text-gray-800 dark:text-white")}>
        Our <span className="text-[#8DC63F] dark:text-[#00AEEF]">Gallery</span>
      </h1>
