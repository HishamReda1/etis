...
import projectsContent from "@/src/content/projects.content"

export default function Projects({ theme }: { theme: "light" | "dark" }) {
  const params = useParams();
  const locale = params?.locale as keyof typeof projectsContent.content || "en";
  const isRTL = locale === "ar";
  const t = projectsContent.content[locale];
